...
class RerouteEnv:
    ...
    def reset(self, state_vec, origin_position, aircraft_type, flight_id=None, origin_code="ORIGIN", fuel_to_origin=None):
        self.state = {
            'lat': state_vec[0],
            'lon': state_vec[1],
        ...
        self.origin_fuel_needed = fuel_to_origin
    ...
    def step(self, action):
        ...
        reward = (0.2 * alt_score + 0.2 * dest_score + 0.2 * origin_score + 0.4 * fuel_eff_score) * 200
